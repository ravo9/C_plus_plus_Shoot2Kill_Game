...
void Text1Scene::Load() {
  cout << "Text Scene 01 Load \n";
  ...
  // Background
  {
	  ...
	  if (!background_texture.loadFromFile("res/img/textBackground_01_01.png"))
...
void Text1Scene::Update(const double& dt) {
  ...
  if (acc == 1) {
	  ...
	  if (!background_texture.loadFromFile("res/img/textBackground_01_02.png"))
		  cerr << "Failed to load spritesheet!" << endl;
	  else
		  cout << "Texture loaded!";
  ...
  if (acc == 3) {
	  ...
	  if (!background_texture.loadFromFile("res/img/textBackground_01_03.png"))
		  cerr << "Failed to load spritesheet!" << endl;
	  else
		  cout << "Texture loaded!";
